...
## MPE (Multi-Processing Extension) 共享内存多处理器
...
## CTE (Context Extension) 上下文和中断管理
...
## VME (Virtual Memory Extension) 虚拟地址空间
